...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    allControls: "startPage,altPrev,pageNumber,altNext,endPage,zoomIn,zoomOut,fullScreen,sound,download,share,outline,play,pageMode,thumbnail,more",
    moreControls: "download,share,outline,play,pageMode,thumbnail",
    hideControls: "",
              ...
              if (_this) {
                ...
                if (isNaN(percentage)) {
                  if (progressData && progressData.loaded) {
                      ...
                      _this.updateInfo("Loading  " + (Math.ceil(progressData.loaded / 10000) / 100).toString() + "% ");
                  } else {
                    _this.updateInfo("Loading  ...");
                  }
                } else {
                  _this.updateInfo("Loading  " + percentage.toString().split(".")[0] + "% ");
                }
              }
            };
          }
...
DFLIP.Share = (function ShareClosure($) {
  ...
  function Share(container, options) {
    ...
    _this.facebook = $(htmlDiv, {
        ...
        title: options.text['facebook']
    }).on("click", function (e) {
      window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(_this.shareUrl), "Sharer", windowParameters);
    });

    _this.reddit = $(htmlDiv, {
        class: shareButtonClass + " df-share-reddit " + options.icons['reddit'],
        title: options.text['reddit']
    }).on("click", function (e) {
        window.open('http://www.reddit.com/submit?url=' + encodeURIComponent(_this.shareUrl), "Sharer", windowParameters);
    });

    _this.google = $(htmlDiv, {
        class: shareButtonClass + " df-share-google " + options.icons['google'],
        title: options.text['google']
    }).on("click", function (e) {
      window.open('https://plus.google.com/share?url=' + encodeURIComponent(_this.shareUrl), "Sharer", windowParameters);
    });
    _this.twitter = $(htmlDiv, {
        class: shareButtonClass + " df-share-twitter " + options.icons['twitter'],
        title: options.text['twitter']
    }).on("click", function (e) {
      window.open('http://twitter.com/share?url=' + encodeURIComponent(_this.shareUrl), "Sharer", windowParameters);
    });
      _this.linkedin = $(htmlDiv, {
          class: shareButtonClass + " df-share-linkedin " + options.icons['linkedin'],
          title: options.text['linkedin']
    }).on("click", function (e) {
          window.open('https://www.linkedin.com/cws/share?url=' + encodeURIComponent(_this.shareUrl), "Sharer", windowParameters);
    });
      _this.tumblr = $(htmlDiv, {
          class: shareButtonClass + " df-share-tumblr " + options.icons['tumblr'],
          title: options.text['tumblr']
      }).on("click", function (e) {
          window.open('https://www.tumblr.com/widgets/share/tool?canonicalUrl=' + encodeURIComponent(_this.shareUrl), "Sharer", windowParameters);
      }); 

      //_this.whatsapp = $(htmlDiv, {
      //    class: shareButtonClass + " df-share-whatsapp " + options.icons['whatsapp']
      //}).on("click", function (e) {
      //    window.open('http://whatsapp://send?text=' + encodeURIComponent(_this.shareUrl), "Sharer", windowParameters);
      //});

        _this.whatsapp = $('<a>', {
            class: shareButtonClass + " df-share-mail " + options.icons['whatsapp'],
            href: 'whatsapp://send?text=Please check out the link: ' + encodeURIComponent(_this.shareUrl),
            target: '_blank',
            'data-action': 'share/whatsapp/share',
            title: options.text['whatsapp']
    }).on("click", function (e) {
        $(this).attr('href', 'whatsapp://send?text=Please check out the link: ' + encodeURIComponent(_this.shareUrl));
    ...
    _this.box.append(_this.urlInput).append(_this.whatsapp).append(_this.facebook).append(_this.linkedin).append(_this.google).append(_this.twitter).append(_this.tumblr).append(_this.reddit).append(_this.mail);
